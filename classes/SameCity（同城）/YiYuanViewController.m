...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.searchBar.placeholder=@"搜索附近的医院";
...
-(void)creatButton
{
    ...
    NSArray *titleArray=@[@"医院",@"门诊",@"会所",@"药店"];
    NSArray *photoArray=@[@"tcyiyuang.png",@"tcmenzhen.png",@"tchuihuisuo.png",@"tcyaodian.png"];
    NSArray *photoArray2=@[@"综合B_55.png",@"综合B_56.png",@"综合B_57.png",@"综合B_58.png"];
