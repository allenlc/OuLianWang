...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.searchBar.placeholder=@"搜索附近的工作单位";
...
-(void)creatButton
{
    ...
    NSArray *photoArray=@[@"tcjianzhi",@"tczhaopin",@"tczhaogongzuo"];///
    NSArray *titleArray=@[@"兼职",@"招聘",@"找工作"];
    NSArray *photoArray2=@[@"综合B_71.png",@"综合B_72.png",@"综合B_73.png"];///
    ...
    for(int i=0;i<3;i++)
    {
        ...
        btn.frame=CGRectMake(45+80*i,10,54,54);
        ...
        UILabel *label=[[UILabel alloc]initWithFrame:CGRectMake(45+80*i,63, 54, 20)];
