...
@interface MeiRongViewController ()
{
...
@implementation MeiRongViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.searchBar.placeholder=@"搜索附近的美容院";
...
-(void)creatButton
{
    ...
    NSArray *titleArray=@[@"美容",@"美发",@"美甲",@"养生"];
    NSArray *photoArray=@[@"tcmeirong.png",@"tcmeihua.png",@"tcmeijia.png",@"tcyangsheng.png"];
    NSArray *photoArray2=@[@"综合B_63.png",@"综合B_65.png",@"综合B_64.png",@"综合B_66.png"];
