...
@interface ChuXingViewController ()
{
...
@implementation ChuXingViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.searchBar.placeholder=@"搜索附近的玩乐天地";
...
-(void)createBtn
{
    NSArray *titleArray=@[@"出租车",@"机票",@"火车票",@"汽车票"];
    NSArray *photoArray=@[@"tcchuzuche.png",@"tcfeijichang.png",@"tchuochezhan.png",@"tckeyunzhan.png"];
    NSArray *photoArray2=@[@"综合B_87.png",@"综合B_90.png",@"综合B_89.png",@"综合B_88.png"];
