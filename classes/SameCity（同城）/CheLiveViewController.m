...
@interface CheLiveViewController ()
{
...
@implementation CheLiveViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.searchBar.placeholder=@"搜索附近的车服务";
...
-(void)creatButton
{
    NSArray *titleArray=@[@"买车",@"卖车",@"拼车",@"维修"];
    NSArray *photoArray=@[@"tcmaiche.png",@"tcmaimaiche.png",@"tcpinche.png",@"tcweixiu.png"];
    NSArray *photoArray2=@[@"综合B_79.png",@"综合B_80.png",@"综合B_81.png",@"综合B_82.png"];
