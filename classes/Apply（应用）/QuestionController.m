...
-(void)deplyNavigationController1
{
    ...
    self.navigationItem.title=@"有问题来找我";
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        Questioncell *jcell=[tableView dequeueReusableCellWithIdentifier:nil];
        if(jcell==nil)
        {
            jcell=[[Questioncell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:nil];
            
        }
        [jcell.btn  setTitle:@"问答" forState:UIControlStateNormal];
        jcell.btn.backgroundColor=ZQColor(15, 88, 252);
        
        [jcell.btn2  setTitle:@"我的" forState:UIControlStateNormal];
        jcell.btn2.backgroundColor=ZQColor(109, 194, 8);
