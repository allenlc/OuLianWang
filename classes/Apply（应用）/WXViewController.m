...
- (void)configData{
    ...
    messBody1.posterPostImage = @[@"ppp111.png",@"ppp222.png",@"ppp333.png"];
    ...
    messBody2.posterPostImage = @[@"ppp111.png",@"ppp222.png",@"ppp333.png"];
    ...
    messBody3.posterPostImage = @[@"ppp111.png",@"ppp222.png",@"ppp333.png",@"ppp222.png",@"ppp111.png",@"ppp333.png"];
    ...
    messBody4.posterPostImage = @[@"ppp111.png",@"ppp222.png",@"ppp333.png",@"ppp111.png",@"ppp333.png"];
    ...
    messBody5.posterPostImage = @[@"ppp111.png",@"ppp222.png",@"ppp333.png",@"ppp333.png"];
    ...
    messBody6.posterPostImage = @[@"ppp111.png",@"ppp222.png",@"ppp333.png",@"ppp333.png",@"ppp222.png"];
